import {
    BlockComponentOnPlaceEvent, BlockComponentPlayerPlaceBeforeEvent, Container, ContainerSlot,
    CustomComponentParameters, EntityComponentTypes, EntityInventoryComponent, ItemStack, ItemTypes, Player,
    StartupEvent,
    system, Vector3,
...
export class CookingPotComponent extends BlockEntityComponent {
    ...
    static init(event: StartupEvent) {
        event.blockComponentRegistry.registerCustomComponent("farmersdelight:cooking_pot", new CookingPotComponent());
    }
}

void CookingPotComponent;
