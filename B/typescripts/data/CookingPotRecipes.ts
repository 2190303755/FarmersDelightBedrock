...
import {
    compileIngredientSpec,
    compileInlineIngredient,
    compileInlineIngredients,
    Ingredient,
    IngredientSpec,
    inlineIngredient,
...
export const COOKING_POT_RECIPES: SortableRecipeManager<CookingPotRecipe> = new SortableRecipeManager();
...
([ //finish
    ...
    COOKING_POT_RECIPES.addSortableRecipe(populateV1(spec));
